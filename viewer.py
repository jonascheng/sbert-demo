...
def view_database(client):
    ...
    if selected_option == "Visualize Collection":
        ...
        updated_item_embedding = st.text_input("Enter the updated embedding of the item:")
